...
// End Cross Module References
	...
	{
		ProcessEvent(FindFunctionChecked(NAME_AFGPlayer_BP_OnConfirm),NULL);
	}
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFGPlayer_BP_OnConfirm_Statics::Function_MetaDataParams[] = {
		{ "Category", "Player" },
		{ "Comment", "/*\n\x09* Callback for whenever the user presses \"Confirm\" aka the left mouse button\n\x09*/" },
		{ "DisplayName", "OnConfirm" },
		{ "ModuleRelativePath", "Player/FGPlayer.h" },
		{ "ToolTip", "* Callback for whenever the user presses \"Confirm\" aka the left mouse button" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AFGPlayer_BP_OnConfirm_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AFGPlayer, nullptr, "BP_OnConfirm", nullptr, nullptr, 0, nullptr, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08020800, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AFGPlayer_BP_OnConfirm_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_AFGPlayer_BP_OnConfirm_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_AFGPlayer_BP_OnConfirm()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFGPlayer_BP_OnConfirm_Statics::FuncParams);
		}
